...
import '../partner_pairing_ui/pairing_choice_screen.dart';
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Future<void> checkUserStatus() async {
    ...
    // final pairingIdFromLink = initialLink != null && initialLink.contains('code=')
    //     ? Uri.parse(initialLink).queryParameters['code']
    //     : null;
    //
    // if (pairingIdFromLink != null) {
    //   Navigator.pushReplacement(
    //     context,
    //     MaterialPageRoute(builder: (_) => const DeepLinkPairingScreen()),
    //   );
    //   return;
    // }
